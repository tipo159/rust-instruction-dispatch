...
void load(internal_instruction_t *restrict instruction, int *restrict memory) {
#if defined(DEBUG)
...
void add(internal_instruction_t *restrict instruction, int *restrict memory) {
#if defined(DEBUG)
  printf("%x: add memory[%d](%d) = memory[%d] + memory[%d]\n", instruction,
         instruction->a, memory[instruction->a], instruction->b,
         instruction->c);
#endif
...
void jmpne(internal_instruction_t *restrict instruction, int *restrict memory) {
#if defined(DEBUG)
  printf("%x: jmpne if memory[%d](%d) != memory[%d](%d) then pp = %x\n",
         instruction, instruction->a, memory[instruction->a], instruction->b,
         memory[instruction->b], instruction->jmp);
#endif
...
void print(internal_instruction_t *restrict instruction, int *restrict memory) {
#if defined(DEBUG)
...
void ret(internal_instruction_t *restrict instruction, int *restrict memory) {
#if defined(DEBUG)
  printf("%x: ret\n", instruction);
#endif
}
